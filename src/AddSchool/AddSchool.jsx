    ...
    <div className="AddSchool">
      ...
      <form onSubmit={formSubmit}>
        ...
        <input
          ...
          name="schoolName"
          required
          onChange={(e) => recordFormData(e, "name")}
        />
        ...
        <input
          ...
          name="city"
          required
          onChange={(e) => recordFormData(e, "city")}
        />
        ...
        <textarea
          ...
          rows="3"
          required
          onChange={(e) => recordFormData(e, "address")}
        ></textarea>
        ...
        <input
          ...
          name="state"
          required
          onChange={(e) => recordFormData(e, "state")}
        />
        ...
        <input
          ...
          pattern="[0-9]{10}"
          required
          onChange={(e) => recordFormData(e, "contact")}
        />
        ...
        <input
          ...
          name="email"
          required
          onChange={(e) => recordFormData(e, "email")}
        />
        ...
        <input
          ...
          accept="image/*"
          onChange={(e) => recordFormData(e, "image")}
        />
